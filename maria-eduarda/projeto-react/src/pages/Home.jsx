...
const Home = () => {
  const list = [
    ...
    {cardTitle:"Ciência de dados", cardDescription:"De forma geral, o profissional dessa área é responsável por estabelecer uma base sólida de dados para executar análises robustas, o que pode ser feito por vários processos. Com essas informações, as empresas conseguem entender o negócio e os consumidores, além de tomar melhores decisões."},
    ...
    {cardTitle:"Desenvolvimento de e-commerce", cardDescription:"Criar e-commerce é mais uma das áreas da tecnologia que há uma grande demanda de profissionais. Seja para montar a loja, o software de cobrança ou para realizar a sua manutenção."},
    {cardTitle:"Cloud computing", cardDescription:"A computação na nuvem requer um profissional que planeje e execute seus processos nas empresas. Assim como ser capaz de realizar a integração do cloud computing com as outras tecnologias da empresa, como a internet das coisas."},
